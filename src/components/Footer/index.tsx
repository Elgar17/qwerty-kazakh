    ...
    <>
      ...
      >
        <p className="indent-4 text-sm text-gray-500 dark:text-gray-300">
          ...
          kazakh，目前该网站使用业余时间在维护，为了保证网站能够持续地提供给大家高质量的服务，我们需要您的帮助！
          <br />
          您的捐款将有助于我们支付网站的运营成本，改进网站的功能和设计，并提高用户体验。
          <br />
        </p>
        <img className="my-4 h-28" src="/qr.png"></img>
      ...
      >
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Qwerty Learner Kazakh 是基于Qwerty Learner 的开源项目，可靠的打字练习工具。
        </p>
        <br />
        <p className="text-sm text-gray-500 dark:text-gray-400">这里也很感谢 Qwerty Learner 项目。</p>
        <br />
        <p className="text-sm text-gray-500 dark:text-gray-400">微信：HARAHOZI_</p>
        <br />
      </InfoPanel>
